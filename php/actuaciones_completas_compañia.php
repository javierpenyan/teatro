 ...
 //introduzco el header y la cabecera dependiendo del tipo de usuario
    ...
    if(isset($_SESSION['tipo'])){
        ...
        if (isset($_POST['actuaciones'])) {
            ...
            echo '<h5 class="display-5 fw-bold" style="color: #FD9815; text-align: center; margin-bottom: 40px; margin-top: 80px; ">Actuaciones de la compañía:</h5>';
            ...
            $consulta->bind_param("i", $compañia);
