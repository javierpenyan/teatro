...
// </div>';
    ...
    echo'<h2 class="display-5 fw-bold" style="color: #FD9815; text-align: center; margin-bottom: 40px; margin-top:80px ">Regístrese como actor</h2>';
    ...
    <form action="#" method="post" enctype="multipart/form-data">
        ...
        <label for="pass">Contraseña, mínimo 6 caracteres, mayúscula, minúscula y número</label>
    ...
    if(isset($_POST['registrarme'])){
        ...
        $sentencia = "SELECT `AUTO_INCREMENT` FROM  INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'teatro' AND   TABLE_NAME = 'actores';";
        ...
        $compruebo = comprueba_registro_cliente($nombre, $apellidos, $alias, $nac, $tel, $correo, $pass);
        ...
        if(!$error_foto && $compruebo == 0){
            ...
            $sentencia = "insert into actores (id, nombre, apellidos, f_nacimiento, telefono, correo, alias, contraseña, foto) values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        
            $consulta = $conexion->prepare($sentencia);

            $consulta->bind_param("issssssss", $siguiente_id, $nombre, $apellidos, $nac, $tel, $correo,$alias , $pass, $reg);//-------------------------------------------------------------
